(() => {
  ...
  const DAY_TWO_ROOT_PATH = [[.508,.274],[.505,.286],[.501,.298],[.501,.318],[.508,.336],[.522,.354],[.536,.392],[.543,.430],[.541,.477],[.526,.523],[.506,.551],[.494,.588],[.492,.607],[.480,.626],[.463,.646],[.447,.665],[.441,.684],[.447,.701],[.459,.718],[.472,.736],[.482,.752],[.485,.765]];
