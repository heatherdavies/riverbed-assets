(() => {
  ...
  const DAY_TWO_ROOT_PATH = [[.5,.282],[.501,.298],[.501,.318],[.508,.336],[.522,.354],[.536,.392],[.543,.430],[.541,.477],[.526,.523],[.506,.551],[.494,.588],[.492,.607],[.469,.626],[.443,.645],[.435,.664],[.447,.692],[.477,.710],[.480,.730],[.499,.767],[.494,.805],[.479,.832],[.475,.851],[.467,.870]];
