# Forest-Only Second-Walk Validation

A fresh Day 1 session contains no personal input, no second stream, and no personal data controls in the slide-out menu. It retains the original forest veil, reflection, and Begin sequence.
